...
useHead({
  title: "Không tìm thấy trang | Sách là bạn",
});
</script>

<template>
  <div
    class="flex flex-col space-y-4 items-center justify-center h-screen bg-zinc-100/90"
  >
    <h1 class="text-6xl md:text-9xl font-bold tracking-tight">404</h1>
    ...
    <Button class="p-4" @click="() => router.push({ path: '/' })"
