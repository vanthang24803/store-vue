...
<template>
  <Container>
    ...
    <div
      class="flex flex-col lg:flex-row md:px-12 px-4 space-y-4 mt-4 lg:space-y-0"
    >
      <ProfileBar />
      <div class="flex flex-col space-y-4 w-full bg-white p-4 rounded-md">
        ...
        <div class="flex flex-col space-y-3" v-show="orders">
          <div
            class="border border-neutral-200 w-full rounded-md p-4 flex flex-col space-x-2"
          ...
          >
            ...
            >
              <div
                class="flex lg:flex-row flex-col lg:items-center lg:space-x-2"
              >
                <h1>Mã vận đơn:</h1>
            ...
            <div class="text-right text-sm">
              <p>
                Tổng tiền:
                <b class="text-xl font-bold text-[#ee4d2d]">
