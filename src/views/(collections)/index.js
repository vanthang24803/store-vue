import Manga from "@/views/(collections)/Manga.vue";
import SachMoi from "@/views/(collections)/SachMoi.vue";
import LightNovel from "@/views/(collections)/LightNovel.vue";
import TieuThuyet from "@/views/(collections)/TieuThuyet.vue";
