...
<template>
  <div class="flex flex-col lg:flex-row lg:container mx-auto">
    <div class="flex flex-col space-y-3 p-8">
      <RouterLink to="/" class="font-bold text-2xl tracking-tight"
        >AMAK Store</RouterLink
      >
      <div class="md:hidden">
        <MobileCart
          :ship="sendChecked"
      ...
      <div
        class="flex items-center space-x-3 text-[12px] text-neutral-500 font-medium"
      >
      ...
      <form
        @submit="onSubmit"
        class="w-full lg:w-[500px] flex flex-col space-y-3"
      >
        ...
        <div>
          <div
            class="w-full rounded-md border border-neutral-200 p-4 flex flex-col space-y-4"
          >
            <div
              class="flex items-center space-x-2"
              @click="handleCheckboxChange('send')"
            >
              <div
                class="w-4 h-4 rounded flex items-center justify-center border border-neutral-700"
              >
            ...
            <div
              class="flex items-center space-x-2"
              @click="handleCheckboxChange('store')"
            >
              <div
                class="w-4 h-4 rounded flex items-center justify-center border border-neutral-700"
              >
        ...
        <Button type="submit" :disabled="loading"> Hoàn tất đơn hàng </Button>
      </form>
    </div>
    <OrderDetail
      :total-price="totalPrice"
