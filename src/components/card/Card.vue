...
<template>
  <div>
    <div
      class="w-full pb-4 bg-white rounded-md hover:shadow-md hover:cursor-pointer flex flex-col overflow-hidden group lg:h-[72vh] h-[55vh] md:h-[65vh] relative"
    >
      <img
      ...
      <div class="flex flex-col space-y-2 p-2 lg:p-4">
        ...
        <div
          class="my-2 lg:absolute lg:bottom-4 flex items-center space-x-4"
          @click="cart.addItem(product, product.options[0].id, 1)"
          v-if="product.options[0].quantity > 0"
        >
          <div
            class="w-9 h-9 flex items-center justify-center bg-[#65b10d] rounded-full animate-bounce"
          >
        ...
        <div class="my-2 flex absolute bottom-4 items-center space-x-4" v-else>
          ...
          <span
            class="font-semibold text-[12px] uppercase text-neutral-400 cursor-not-allowed"
          >
            Hết hàng
          </span>
        </div>
