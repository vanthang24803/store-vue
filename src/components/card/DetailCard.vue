    ...
    <div class="flex md:flex-row flex-col md:space-x-12">
      ...
      <div class="flex flex-col space-y-2 lg:basis-3/4">
        ...
        <div class="flex items-center space-x-4">
          <div class="text-sm">
            Tình trạng:
            <span v-if="option?.status" class="text-[#417505] font-bold"
              >Còn hàng</span
            >
          ...
          <div class="flex flex-col space-y-4 lg:w-1/2">
            ...
            >
              ...
              <div class="flex items-center space-x-8">
                ...
                <span
                  v-if="Number(option?.sale) > 0"
                  class="text-neutral-400 text-lg line-through"
                >
                  {{ price(option?.price) }}₫
                </span>
                <Button
            ...
            <div class="flex items-center space-x-4 text-sm py-2">
              ...
              >
                <Button
                  ...
                  @click="handleOptionChange(item.id)"
                >
                  {{ item.name }}
                </Button>
              </div>
            ...
            <div class="flex items-center space-x-2 text-sm py-4">
              ...
              <div className="flex items-center space-x-2">
                <Button
                  size="icon"
                  :disabled="total <= 1"
                  :variant="total > 0 && outline"
                  class="font-medium"
                  @click="total > 0 ? total-- : null"
                >
                  <Minus />
                </Button>
            ...
            <Button
              variant="primary"
              @click="cart.addItem(product, option.id, total)"
            >
              Thêm vào giỏ hàng
            </Button>
