  ...
  <Sheet>
    <SheetTrigger>
      <div class="relative hover:cursor-pointer">
        <CartSvg />
        <div
          class="w-5 h-5 flex items-center justify-center rounded-full bg-red-500 absolute -top-2 -right-2"
        >
    ...
    <SheetContent>
      ...
      <div class="flex flex-col space-y-2 mt-4">
        <ScrollArea class="lg:h-[74vh] md:h-[82vh] h-[76vh] w-full">
          <div
            class="flex items-center justify-center flex-col space-y-4 h-[50vh]"
            v-if="cart.totalItems == 0"
          >
            <ShoppingBasket class="w-20 h-20" />
            <span class="text-muted-foreground text-sm"
              >Hiện chưa có sản phẩm</span
            >
          </div>
          <div v-else>
            <div
              ...
              <div class="flex space-x-4">
                ...
                <div class="flex flex-col">
                  <div class="relative w-[220px]">
                    ...
                    <X
                      class="w-4 h-4 absolute top-0 -right-4"
                      @click="
                        cart.removeItem(
                          item.product.id,
                  ...
                  <div class="flex items-center space-x-5">
                    ...
                    <span
                      v-if="item.product.options[0].sale > 0"
