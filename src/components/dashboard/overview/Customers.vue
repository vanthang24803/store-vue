...
<template>
  <div class="p-2">
    <Card>
      ...
      >
        <CardTitle class="text-xl font-bold"> Customers </CardTitle>
        <CardDescription>
      ...
      <CardContent>
        <Tabs :default-value="select" @update:model-value="select = $event">
          <TabsList
            className="grid w-full grid-cols-3 dark:bg-gray-900/90 bg-neutral-200/90"
          >
            ...
            <Card v-else class="w-full mt-2">
              ...
              >
                ...
                <div class="flex items-center justify-between">
                  <h3 class="text-base font-semibold">Total</h3>
