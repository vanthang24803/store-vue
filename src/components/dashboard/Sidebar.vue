    ...
    <div class="h-full border-r flex flex-col overflow-y-auto shadow-sm light:bg-neutral-50/80">
        ...
        <div class="p-2 rounded" v-for="route in routes" :key="route.name">
            <router-link :to="route.path"
                :class="`flex items-center px-6 py-3 text-sm font-medium  rounded-md light:hover:bg-neutral-100 dark:hover:bg-gray-900 ${pathname === route.path && 'bg-neutral-100 dark:bg-gray-900  text-blue-500 font-semibold'}`">
