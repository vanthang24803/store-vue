...
const getProvinceName = (id) =>
  provinces.value.find((province) => province.province_id === id)
    ?.province_name;
const getDistrictName = (id) =>
  districts.value.find((district) => district.district_id === id)
    ?.district_name;
const getWardName = (id) =>
  wards.value.find((ward) => ward.ward_id === id)?.ward_name;
</script>
